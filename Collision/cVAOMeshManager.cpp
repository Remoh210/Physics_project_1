...
bool cVAOMeshManager::FindDrawInfoByModelName(std::string model_name, sModelDrawInfo &drawInfo )
{
	std::map< std::string /*model name*/, sModelDrawInfo >::iterator itModel = this->m_mapModel_to_VAOID.find(model_name);
...
//bool cVAOMeshManager::findMeshByNameVAO(std::string mesh_name, sModelDrawInfo &drawInfo)
//{
//	std::map< std::string, sModelDrawInfo >::iterator itMesh =
//		this->m_mapModel_to_VAOID.find(mesh_name);
//
//	if (itMesh == this->m_mapModel_to_VAOID.end())
//	{
//		return false;
//	}
